...
export default class Display {
	...
	init() {
		...
		function drawUnitMenu(pColors, player, scale){
			...
			s.vertex(refXX+siz*.25,refYY);
			s.vertex(refXX+siz*.25,refYY+siz*.75);
			s.vertex(refXX+siz*1,refYY+siz*.75);
			s.vertex(refXX+siz*1,refYY+siz*1);
			s.vertex(refXX+siz*.25,refYY+siz*1);
			s.vertex(refXX+siz*.25,refYY+siz*1.75);
			s.vertex(refXX,refYY+siz*1.75);
			s.vertex(refXX,refYY+siz*1);
			s.vertex(refXX-siz*.75,refYY+siz*1);
			s.vertex(refXX-siz*.75,refYY+siz*.75);
			s.vertex(refXX,refYY+siz*.75);
			s.vertex(refXX,refYY);
			s.endShape();
